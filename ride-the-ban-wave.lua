...
local Button = MainTab:CreateButton({
   Name = "FE Fling GUI (Seperate Script)",
   Callback = function()
...
local Section = AimbotTab:CreateSection(" ")

local Button = AimbotTab:CreateButton({
   Name = "Aimbot (Rejoin to remove)",
   Callback = function()
...
local Section = ScriptsTab:CreateSection(" ")
